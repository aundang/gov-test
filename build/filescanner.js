 ...
 */
var processFile = function (filename) { return __awaiter(void 0, void 0, void 0, function () {
    var fileStream, readLineStream;
    return __generator(this, function (_a) {
        fileStream = fs.createReadStream(filename);
        readLineStream = readline.createInterface({
            input: fileStream
        });
        readLineStream.on('line', function (line) {
            var strLine = line.toUpperCase();
            var path = null;
